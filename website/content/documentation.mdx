...
<PropTable items={[
  ...
  { name: "container", type: "RefObject<HTMLElement | null>", default: "undefined", description: "React ref to scrollable container (defaults to window). Assumed stable for the lifetime of the hook — remount to change it" },
  ...
  { name: "onActive", type: "(id: string | null, prevId: string | null) => void", default: "undefined", description: "Called when active section changes" },
  { name: "onEnter", type: "(id: string) => void", default: "undefined", description: "Called when a section enters the viewport" },
  { name: "onLeave", type: "(id: string) => void", default: "undefined", description: "Called when a section leaves the viewport" },
  { name: "onScrollStart", type: "() => void", default: "undefined", description: "Called when scrolling starts" },
  { name: "onScrollEnd", type: "() => void", default: "undefined", description: "Called when scrolling stops (after 100ms of inactivity)" },
]} />
...
<PropTable items={[
  { name: "offset (px)", type: "-10000 to 10000", default: "0", description: "Pixel offset from the top of the viewport" },
  { name: "offset (%)", type: "-500% to 500%", default: "0", description: "Percentage of viewport height" },
  { name: "threshold", type: "0 to 1", default: "0.6", description: "Minimum visibility ratio for high-score detection" },
  { name: "hysteresis", type: "0 to 1000", default: "150", description: "Score margin required to switch active section" },
  { name: "throttle", type: "0 to 1000 ms", default: "10", description: "Minimum interval between recalculations" },
]} />
...
<PropTable items={[
  ...
  { name: "navRef", type: "(id: string, options?: NavRefOptions) => (el: HTMLElement | null) => void", description: "Ref callback for nav items; auto-scrolls active item into view in scrollable nav containers" },
